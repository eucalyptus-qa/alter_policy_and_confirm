...
my $group_name = "no-access-group";
create_account_group($account_name, $group_name);
print "\n";


###
### Assign a NoAccess Policy
###
...
my $policy_filename = "noaccess.policy";
...
print "\n";
print "[TEST_REPORT]\tASSIGN USER TO GROUP WITH NOACCESS HAS BEEN COMPLETED\n";
print "\n";
